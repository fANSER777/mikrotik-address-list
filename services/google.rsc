...
# Subnets: 99 | IPs: ~22,179,840
#
# MikroTik usage:
#   /tool fetch url="http://YOUR_PANEL/rsc/google.rsc"
#   /import file-name=google.rsc
#
/ip firewall address-list
remove [find list=GOOGLE]
...
add address=34.4.0.0/14 list=GOOGLE
...
add address=35.200.0.0/13 list=GOOGLE
...
add address=136.23.39.0/24 list=GOOGLE
...
add address=136.121.8.0/21 list=GOOGLE
